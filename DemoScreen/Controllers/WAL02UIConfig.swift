...
extension WAL02UIConfig {
    ...
    var attributedTitle: NSAttributedString {
        let titleAttributes = TextAttributes(font: .regular(25), foregroundColor: titleColor, lineHeight: 30).dictionary
        let subtitleAttribute = TextAttributes(font: .regular(20), foregroundColor: subtitleColor, lineHeight: 30).dictionary
    ...
    var attributedPurchaseText: NSAttributedString {
        let attributes = TextAttributes(alignment: .center, font: .regular(10), foregroundColor: termsOfUseTextColor)
        return purchaseTitle.attributed(attributes)
    }
    
    var attributedRestore: NSAttributedString {
        let attributes = TextAttributes(alignment: .center, font: .regular(11), foregroundColor: restoreButtonTextColor)
